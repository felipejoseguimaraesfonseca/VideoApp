 ...
 * Use the [SubscriptionsMostRelevantFragment.newInstance] factory method to
...
class SubscriptionsMostRelevantFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SubscriptionsMostRelevantFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SubscriptionsMostRelevantFragment().apply {
