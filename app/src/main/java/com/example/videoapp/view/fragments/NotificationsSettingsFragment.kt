 ...
 * Use the [NotificationsSettingsFragment.newInstance] factory method to
...
class NotificationsSettingsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotificationsSettingsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NotificationsSettingsFragment().apply {
